<div class="card">
    <div class="card-body">
        <div class="card fs--1 bg-light mt-2 mb-3">
            <div class="card-body ">
                <form action="https://icopify.co/project/2042/publishers" method="get">
                    <div class="form-row">
                <!-- DA -->
                ...
                <!-- Categories -->
                        <div class="form-group col-md-4">
                            ...
                            <select id="category" name="category" class="custom-select custom-select-sm">
                                ...
                                <option value="{{ $category->site_category }}">{{ $category->site_category }}</option>ss
                                @endforeach
                            </select>
                        </div>
                <!-- Categories -->
                ...
                <!-- Language -->
                    ...
                    <div class="form-row">
                        ...
                        <!-- Max Links Allow -->
                        <div class="form-group col-md-2">
                            <label for="max_links_allow">Max Links Allow</label>
                        ...
                        <!-- Marked As Sponsored-->
                        <div class="form-group col-md-3">
                            <label for="sponsored">Marked As Sponsored</label>
                    ...
                    <div class="form-row clearfix">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select id="monthlyTraffic" name="monthlyTraffic" class="custom-select-sm custom-select">
                                <option selected value="All">All</option>
                                <option value="A">Monthly Traffic &gt;= 1 000</option>
                                <option value="B">Monthly Traffic &gt;= 10 000</option>
                                <option value="C">Monthly Traffic &gt;= 50 000</option>
                                <option value="D">Monthly Traffic &gt;= 100 000</option>
                                <option value="E">Monthly Traffic &gt;= 200 000</option>
                                <option value="F">Monthly Traffic &gt;= 300 000</option>
                                <option value="G">Monthly Traffic &gt;= 400 000</option>
                                <option value="H">Monthly Traffic &gt;= 500 000</option>
                                <option value="I">Monthly Traffic &gt;= 600 000</option>
                                <option value="J">Monthly Traffic &gt;= 700 000</option>
                                <option value="K">Monthly Traffic &gt;= 800 000</option>
                                <option value="L">Monthly Traffic &gt;= 900 000</option>
                                <option value="M">Monthly Traffic &gt;= 1 000 000</option>
                                <option value="N">Monthly Traffic &gt;= 10 000 000</option>
                            </select>
                        </div>
                        <!-- Monthly Traffic -->
                        ...
                        <!-- Monthly Traffic-->
                        <div class="form-group col-md-2">
                            <label for="stateGrid">Moz Spam Score
                            ...
                            <select id="spamScore" name="spamScore" class="custom-select-sm custom-select">
                                <option selected="" value="All">All</option>
                                <option value="A">Spam Score &lt;= 01</option>
                                <option value="B">Spam Score &lt;= 02</option>
                                <option value="C">Spam Score &lt;= 05</option>
                                <option value="D">Spam Score &lt;= 10</option>
                                <option value="E">Spam Score &lt;= 20</option>
                                <option value="F">Spam Score &lt;= 30</option>
                                </select>
                        </div>
                        <!-- Monthly Traffic -->
                        ...
                        <div class="form-group col-md-3">
                            <label for="worked_ith_or_not">Sites I've (haven't) Worked With</label>
                            <select id="worked_ith_or_not" name="worked_ith_or_not" class="custom-select-sm custom-select">
                        ...
                        <!-- End Exclude website I have worked with -->
                                ...
                                <div class="ml-auto float-right mt-4">
                                    <a id="resetButton" href="#" role="button" class="btn btn-sm loading-trigger" style="background-color:#3c5a99; color:white">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm loading-trigger">
