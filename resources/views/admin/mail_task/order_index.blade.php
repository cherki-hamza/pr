                    ...
                    <div class="col-12">
                        <div class="card card-primary border-primary">
                            ...
                            <div class="card-header">
                                ...
                                </i>Estimated completion: <strong>{{ $site_time ?? '' }} , And The Task Start From  <span style="color: goldenrod">{{ $date }}</span> To <span style="color: goldenrod">{{ $to }}</span></strong></span>
                            </div>
